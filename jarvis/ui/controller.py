...
from jarvis.ai.openai_wrapper import GLOBAL_DEFAULT_MODEL, OpenAIWrapper
...
class UIController(QObject):
    ...
    def __init__(self, parent=None) -> None:
        ...
        try:
            ...
            # self.transcription_worker.transcriptionReady.connect(self.process_user_input) # Removed: Connection handled in main.py via dialog
